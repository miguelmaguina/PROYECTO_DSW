...
<head>
    ...
    <link rel="stylesheet" href="../css/vistaPendienteEmp.css?v=<?php echo time(); ?>">
        ...
        <div class="contenedor-t">
                <div class="row">
                    <div class="button-container col-sm-12 col-md-12 mb-3 mt-4 text-white d-flex justify-content-center ">
                        ...
                        <img class="rounded img-fluid mx-auto d-block" src="../img/productoVEmp.png" alt="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row text-center">
                                    ...
                                    <button class="btn btn-primary m-1">Aceptar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
